      ...
      <ScrollView style={{ flex: 1, paddingHorizontal: 0 }}>
        ...
        <View style={{ marginHorizontal: 16, marginVertical: 16, backgroundColor: '#1E293B', borderRadius: 20, padding: 18, borderWidth: 1, borderColor: '#334155' }}>
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
            <div>
              <Text style={{ color: '#94A3B8', fontSize: 12, fontWeight: 'bold', textTransform: 'uppercase', letterSpacing: 1 }}>TOTAL AMOUNT DUE</Text>
              <Text style={{ color: '#64748B', fontSize: 11, marginTop: 2 }}>Cash Payment at Counter</Text>
            </div>
        ...
        <View style={{ marginHorizontal: 16, marginBottom: 16 }}>
          <Text style={{ color: '#94A3B8', fontSize: 12, marginBottom: 6, fontWeight: '600' }}>Add Note / Special Request</Text>
          <TextInput
        ...
        <View style={{ marginHorizontal: 16, marginBottom: 20 }}>
          ...
          >
            <Text style={{ color: 'white', fontWeight: 'bold', fontSize: 16 }}>
              ₱{total.toFixed(2)} • Proceed to Payment
            </Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
