...
import { Smartphone, Plus, Wifi, WifiOff } from 'lucide-react';
            ...
            <div key={device.id} className="bg-slate-900 border border-slate-800 rounded-xl p-5 space-y-3">
              ...
              <div className="p-3 bg-slate-950 rounded-lg border border-slate-800 space-y-1 text-xs">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-mono text-slate-400">{branch ? branch.code : 'BR-XX'}</span>
                </div>
                <div className="flex justify-between">
              ...
              <div className="flex justify-between items-center text-xs text-slate-500 pt-1">
                ...
                <span className="text-emerald-400">Ready for Orders</span>
              </div>
            </div>
          );
        })}
