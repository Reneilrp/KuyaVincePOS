...
import { Building2, Calendar, RefreshCw, Layers } from 'lucide-react';
    ...
    <header className="bg-slate-900/90 backdrop-blur-md border-b border-slate-800 sticky top-0 z-30 px-6 py-3.5 no-print">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <div>
          ...
          <p className="text-[11px] text-slate-400">100% Real-Time Cloud Database • Zero Mock Data</p>
        </div>

        {/* Right: Branch Switcher, Date Filter & Refresh */}
